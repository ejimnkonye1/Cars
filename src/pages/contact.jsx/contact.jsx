    ...
    return(
        ...
        <section className="ftco-section contact-section py-10">
                        ...
                        <div className="mb-5">
                            <div className="border w-full p-4 rounded mb-2 flex">
                                <div className="icon mr-3">
                                    <span className="icon-map-o"><FaMap /></span>
                                </div>
                                <p>
                                    <span className="font-semibold">Address:</span> 198 West 21th Street, Suite 721 New York NY 10016
                                </p>
                            </div>
                        </div>
                        <div className="mb-5">
                            <div className="border w-full p-4 rounded mb-2 flex">
                                <div className="icon mr-3">
                                    <span className="icon-mobile-phone"><MdOutlinePhoneIphone />
                                    </span>
                                </div>
                                <p>
                                    <span className="font-semibold">Phone:</span> <a href="tel://1234567920" className="text-blue-500">+ 1235 2355 98</a>
                                </p>
                            </div>
                        </div>
                        <div className="mb-5">
                            <div className="border w-full p-4 rounded mb-2 flex">
                                <div className="icon mr-3">
                                    <span className="icon-envelope-o"><IoMdMail />
                                    </span>
                                </div>
                                <p>
                                    <span className="font-semibold">Email:</span> <a href="mailto:info@yoursite.com" className="text-blue-500">info@yoursite.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="w-full lg:w-2/3 mb-5 lg:pl-5">
                        <form action="#" className="bg-gray-100 p-5 rounded shadow-md">
                            <div className="mb-4">
            ...
            <div className="w-full md:w-2/3">
                <div className="relative bg-white w-full h-full rounded-lg shadow overflow-hidden"> 
                    <iframe 
                        className="absolute top-0 left-0  h-screen rounded-lg border-0"
